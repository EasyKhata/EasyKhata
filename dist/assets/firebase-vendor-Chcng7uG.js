 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pl(n,e,t=!1){if(Se(n.app))return Promise.reject(tt(n));const r="signIn",s=await Rl(n,r,e),o=await Kt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(o.user),o}async function Om(n,e){return Pl(Ot(n),e)}async function JT(n,e){return Sl(K(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rI(n,e){return K(n).setPersistence(e)}function Mm(n,e,t,r){return K(n).onIdTokenChanged(e,t,r)}function xm(n,e,t){return K(n).beforeAuthStateChanged(e,t)}function sI(n,e,t,r){return K(n).onAuthStateChanged(e,t,r)}function iI(n){return K(n).signOut()}const gs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hI(){return new kr("deleteField")}function dI(...n){return new ea("arrayUnion",n)}function fI(n){return new ta("increment",n)}const Ou="@firebase/firestore",Lu="4.13.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function EI(n){n=be(n,re);const e=be(n.firestore,ct),t=Pr(e);return QE(t,n._key).then(r=>yd(e,n,r))}function TI(n){n=be(n,Je);const e=be(n.firestore,ct),t=Pr(e),r=new ra(e);return md(n._query),YE(t,n._query).then(s=>new Wt(e,r,n,s))}function II(n,e,t){n=be(n,re);const r=be(n.firestore,ct),s=_d(n.converter,e,t),o=Cr(r);return si(r,[ad(o,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,Ce.none())])}function wI(n,e,t,...r){n=be(n,re);const s=be(n.firestore,ct),o=Cr(s);let a;return a=typeof(e=K(e))=="string"||e instanceof ei?ud(o,"updateDoc",n._key,e,t,r):cd(o,"updateDoc",n._key,e),si(s,[a.toMutation(n._key,Ce.exists(!0))])}function vI(n){return si(be(n.firestore,ct),[new Ks(n._key,Ce.none())])}function AI(n,...e){var d,p,_;n=K(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Mu(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(Mu(e[r])){const w=e[r];e[r]=(d=w.next)==null?void 0:d.bind(w),e[r+1]=(p=w.error)==null?void 0:p.bind(w),e[r+2]=(_=w.complete)==null?void 0:_.bind(w)}let o,a,u;if(n instanceof re)a=be(n.firestore,ct),u=js(n._key.path),o={next:w=>{e[r]&&e[r](yd(a,n,w))},error:e[r+1],complete:e[r+2]};else{const w=be(n,Je);a=be(w.firestore,ct),u=w._query;const P=new ra(a);o={next:V=>{e[r]&&e[r](new Wt(a,P,w,V))},error:e[r+1],complete:e[r+2]},md(n._query)}const l=Pr(a);return KE(l,u,s,o)}function si(n,e){const t=Pr(n);return JE(t,e)}function yd(n,e,t){const r=t.docs.get(e._key),s=new ra(n);return new Ht(n,s,e._key,r,new tr(t.hasPendingWrites,t.fromCache),e.converter)}function RI(n){return n=be(n,ct),Pr(n),new hT(n,e=>si(n,e))}(function(e,t=!0){Qg(en),Pt(new rt("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ct(new Xg(r.getProvider("auth-internal")),new t_(a,r.getProvider("app-check-internal")),E_(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),De(Ou,Lu,e),De(Ou,Lu,"esm2020")})();var dT="firebase",fT="12.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AT(n,e,t){let r=1,s=null,o=null,a=!1,u=0;function l(){return u===2}let d=!1;function p(...k){d||(d=!0,e.apply(null,k))}function _(k){s=setTimeout(()=>{s=null,n(P,l())},k)}function w(){o&&clearTimeout(o)}function P(k,...q){if(d){w();return}if(k){w(),p.call(null,k,...q);return}if(l()||a){w(),p.call(null,k,...q);return}r<64&&(r*=2);let Q;u===1?(u=2,Q=0):Q=(r+Math.random())*1e3,_(Q)}let V=!1;function D(k){V||(V=!0,w(),!d&&(s!==null?(k||(u=2),clearTimeout(s),_(0)):k||(u=1)))}return _(0),o=setTimeout(()=>{a=!0,D(!0)},t),D}function RT(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Id="storage";function SI(n=Os(),e){n=K(n);const r=_r(n,Id).getImmediate({identifier:e}),s=mo("storage");return s&&UT(r,...s),r}function UT(n,e,t,r={}){xT(n,e,t,r)}function BT(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new FT(t,r,s,e,en)}function qT(){Pt(new rt(Id,BT,"PUBLIC").setMultipleInstances(!0)),De($u,ju,""),De($u,ju,"esm2020")}qT();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PI(n=Os(),e=po){const r=_r(K(n),wd).getImmediate({identifier:e}),s=mo("functions");return s&&QT(r,...s),r}function QT(n,e,t){zT(K(n),e,t)}KT();export{pI as A,mI as B,dI as C,gI as D,Pn as E,_I as F,YT as G,yI as H,oI as a,SI as b,PI as c,Vl as d,iI as e,EI as f,lI as g,uI as h,Rp as i,eI as j,tI as k,XT as l,wI as m,ZT as n,sI as o,II as p,TI as q,JT as r,rI as s,cI as t,nI as u,AI as v,RI as w,hI as x,fI as y,vI as z};
